 ...
 * 
 * Blog Post: https://chentiangemalc.wordpress.com/2012/08/24/command-line-proxy-tool-with-c-source/
 */
...
namespace SetProxy
{
    static class ProxyRoutines
    {
        ...
        /// <returns></returns>
        public static bool SetProxy(bool EnableProxy, bool EnableAutoDetect, string ProxyAddress,
                                    string ProxyExceptions, string AutoConfigURL, string ConnectionName = "")
        {
